...
if(isset($_POST['submit'])){
	$sql = "DELETE FROM articles WHERE articles_id ='$articles_id'";
	$stmt = $conn->stmt_init();
	$stmt->prepare($sql);
	$stmt->execute();
	echo $stmt->error;
...
<head>
<meta charset="utf-8">
<title>Delete article - Kayz Journal</title>
            ...
            <div id="mainmenu">
                ...
                <div id="rightsidemenu">
                	<div id="innerrightsidemenu">
                        ...
                        <p style="padding-bottom:30px;">Are you sure you want to delete this article?</p>
