...
if(isset($_POST['submit'])){
	$sql = "DELETE FROM books WHERE books_id =".$book_id;
	$stmt = $conn->stmt_init();
	$stmt->prepare($sql);
	$stmt->execute();
	echo $stmt->error;
	if($stmt->affected_rows > 0){
		...
		exit;
			...
			echo 'Cannot delete book now. Try again later.';	
	}
...
<head>
<meta charset="utf-8">
<title>Delete book - Kayz Journal</title>
            ...
            <div id="mainmenu">
                ...
                <div id="rightsidemenu">
                	<div id="innerrightsidemenu">
                        ...
                        <p style="padding-bottom:30px;">Are you sure you want to delete this book?</p>
