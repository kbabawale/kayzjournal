...
if(isset($_POST['submit'])){
	$sql = "DELETE FROM activities WHERE activities_id ='$acti_id'";
	$stmt = $conn->stmt_init();
	$stmt->prepare($sql);
	$stmt->execute();
	echo $stmt->error;
	if($stmt->affected_rows > 0){
		...
		exit;
			...
			echo 'Cannot delete activity now. Try again later.';	
	}
...
<head>
<meta charset="utf-8">
<title>Delete activity - Kayz Journal</title>
            ...
            <div id="mainmenu">
                ...
                <div id="rightsidemenu">
                	<div id="innerrightsidemenu">
                        ...
                        <p style="padding-bottom:30px;">Are you sure you want to delete this activity?</p>
