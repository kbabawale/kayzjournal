...
if(isset($_POST['submit'])){
	...
	$expected = array('name_of_book','edit_status','author','edition','year');
	
	//set required fields
	$required = array('name_of_book');
...
if(!$suspect && !$missing){
		...
		$sql = 'INSERT INTO books (name_of_book, status_id, author, edition, year, date_created) VALUES (?,?,?,?,?,NOW())';
			
			//require_once('includes/connection.inc.php');

			$stmt = $conn->stmt_init();
			$stmt->prepare($sql);
			$stmt->bind_param('sissi', $name_of_book, $edit_status, $author, $edition, $year);
			$stmt->execute();
			$err = $stmt->error;
			
			if($stmt->affected_rows == 1){
				header('Location:personal_philosophy.php?ref=books');
				exit;	
			}elseif($err){
			}
...
<head>
<meta charset="utf-8">
<title>Add new book - Kayz Journal</title>
                        ...
                        <form method="post" action="" id="frm1" name="frm1">
                        	<table border="0" width="100%" style="font-style:normal;">
                                <tr>
                                    ...
                                    <td  width="50%"> 
                                        <input type="text" id="name_of_book" name="name_of_book"
                                        <?php if($missing || $errors) {echo 'value="'. htmlentities($_POST['name_of_book'], ENT_COMPAT, 'UTF-8') 
										.'"';} ?>
                                ...
                                <tr>
                                    ...
                                    <td>    
                                        ...
                                        onfocus="this.style.border='solid #000 1px';">
                                        	<option value="1">Not Acquired</option>
                                ...
                                <tr>
                                    ...
                                    <td  width="50%"> 
                                        ...
                                        <?php if($missing || $errors) {echo 'value="'. htmlentities($_POST['author'], ENT_COMPAT, 'UTF-8') 
										.'"';} ?>
                                        style="width:80%; height:30px; margin:5px 0 0 0; padding:5px;color:#000; background:inherit; 
                                        border:#000 solid 1px;
                                        font-size:1.0em;font-family:'Microsoft JhengHei',Microsoft JhengHei Light;"/>
                                ...
                                <tr>
                                    ...
                                    <td  width="50%"> 
                                        ...
                                        <?php if($missing || $errors) {echo 'value="'. htmlentities($_POST['edition'], ENT_COMPAT, 'UTF-8') 
										.'"';} ?>
                                        style="width:80%; height:30px; margin:5px 0 0 0; padding:5px;color:#000; background:inherit; 
                                        border:#000 solid 1px;
                                        font-size:1.0em;font-family:'Microsoft JhengHei',Microsoft JhengHei Light;"/>
                                ...
                                <tr>
                                    ...
                                    <td  width="50%"> 
                                        ...
                                        <?php if($missing || $errors) {echo 'value="'. htmlentities($_POST['year'], ENT_COMPAT, 'UTF-8') 
										.'"';} ?>
                                        style="width:80%; height:30px; margin:5px 0 0 0; padding:5px;color:#000; background:inherit; 
                                        border:#000 solid 1px;
                                        font-size:1.0em;font-family:'Microsoft JhengHei',Microsoft JhengHei Light;"/>
