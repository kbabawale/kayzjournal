...
if(isset($_POST['submit'])){
	$sql = "DELETE FROM quotes WHERE quote_id ='$quote_id'";
	$stmt = $conn->stmt_init();
	$stmt->prepare($sql);
	$stmt->execute();
	echo $stmt->error;
	if($stmt->affected_rows > 0){
		...
		exit;
			...
			echo 'Cannot delete quote now. Try again later.';	
	}
...
<head>
<meta charset="utf-8">
<title>Delete quote - Kayz Journal</title>
            ...
            <div id="mainmenu">
                ...
                <div id="rightsidemenu">
                	<div id="innerrightsidemenu">
                        ...
                        <p style="padding-bottom:30px;">Are you sure you want to delete this quote?</p>
