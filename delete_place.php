...
if(isset($_POST['submit'])){
	$sql = "DELETE FROM places WHERE places_id ='$place_id'";
	$stmt = $conn->stmt_init();
	$stmt->prepare($sql);
	$stmt->execute();
	echo $stmt->error;
	if($stmt->affected_rows > 0){
		...
		exit;
			...
			echo 'Cannot delete location now. Try again later.';	
	}
...
<head>
<meta charset="utf-8">
<title>Delete place - Kayz Journal</title>
            ...
            <div id="mainmenu">
                ...
                <div id="rightsidemenu">
                	<div id="innerrightsidemenu">
                        ...
                        <p style="padding-bottom:30px;">Are you sure you want to delete this location?</p>
